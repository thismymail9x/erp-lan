<div class="perm-user-info-header m-b-20">
...
<form id="permissionForm" onsubmit="savePermissions(event, <?= $user['id'] ?>)">
    <?= csrf_field() ?>
    <div class="perm-groups-scroll">
        <?php foreach($groupedMatrix as $groupName => $perms) { ?>
            <div class="permission-group m-b-20">
                <h4 class="font-weight-600 text-apple-main perm-group-header"><?= esc($groupName) ?></h4>
                <table class="premium-table perm-table-full">
                    <thead>
                        <tr>
                            <th class="perm-col-40">Tính năng / Quyền thao tác</th>
                            <th class="table-cell-center perm-col-20"><span class="badge-secondary-minimal" title="Áp dụng lại cài đặt gốc của vai trò hiện tại">Mặc định (Role)</span></th>
                            <th class="table-cell-center perm-col-20"><span class="badge-success-minimal" title="Cấp quyền trực tiếp cho cá nhân này">Thêm quyền</span></th>
                            <th class="table-cell-center perm-col-20"><span class="badge-danger-minimal" title="Cấm cá nhân này sử dụng tính năng">Giảm quyền</span></th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    <div class="form-actions-row m-t-20 pt-15 perm-actions-row">
